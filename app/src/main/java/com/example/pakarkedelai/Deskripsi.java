...
import com.example.pakarkedelai.API.Server;
import com.example.pakarkedelai.App.AppController;
...
public class Deskripsi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Deskripsi.this, ""+id, Toast.LENGTH_SHORT).show();
        ...
        iya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (y.equals("P")){
                    Intent intent = new Intent(Deskripsi.this, solusi.class);
                    intent.putExtra("id",Y);
                    startActivity(intent);
                    finish();
                }
                else if(y.equals("G")){
                    Intent intent = new Intent(Deskripsi.this, Deskripsi.class);
                    intent.putExtra("id",Y);
                    startActivity(intent);
                    finish();
                }
        ...
        tidak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (t.equals("P")){
                    ...
                    Toast.makeText(Deskripsi.this, "Tidak SAkit kakak", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Deskripsi.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                }
